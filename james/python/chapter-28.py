...
customer_115_2 = {1: "James", 2: "Anderson", 3: "2203 random address"}

# To pick out a number, you do it like this:
# This would be "Anderson", its not like a list
customer_115_23 = customer_115_2[2]

# Values can be numbers aswell
customer_115_3 = {"first name": 1, "last name": 2, "address": 3}

# To pick out a value you do this
customer_115_32 = customer_115_3["last name"] # is 2
